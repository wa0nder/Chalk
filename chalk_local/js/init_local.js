...
let DataService = createLocalDataService('127.0.0.1','426f62');

let db = DataService.getDB();
let doc = {
...
db.put(doc)
.then(function () {
    console.log("Success! query document created.");
})
.catch(function (err) {
    console.log('Error, query doc could not be created: ', err);
});